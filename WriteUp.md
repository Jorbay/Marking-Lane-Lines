...
Running the script: Just run the LaneLines_script jupyter notebook one cell at a time in order. The last cell contains the name of the video to be used, which by default is the project video in file.
